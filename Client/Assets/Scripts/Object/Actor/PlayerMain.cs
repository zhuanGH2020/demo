...
/// 玩家角色
/// </summary>
public partial class PlayerMain : CombatEntity
{
    private static PlayerMain _instance;
    public static PlayerMain Instance => _instance;
    ...
    private void TryAttackInMouseDirection(Vector3 mousePosition)
    {
        ...
        Debug.Log($"[PlayerMain] 向鼠标方向攻击: {mousePosition}");
    }
